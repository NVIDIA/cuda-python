# This file was generated by stubgen-pyx v0.2.22 from cuda_core/cuda/core/graph/_adjacency_set_proxy.pyx
...
_S = TypeVar('_S')
_adj_fn_t: TypeAlias = Callable[[cydriver.CUgraphNode, cydriver.CUgraphNode, int], cydriver.CUresult]
