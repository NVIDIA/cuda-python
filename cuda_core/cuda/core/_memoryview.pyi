...
class StridedMemoryView:
    ...
    def __init__(self, obj: object | None=None, stream_ptr: int | None=None) -> None: ...
    @classmethod
    ...
    def as_tensor_map(self, box_dim: tuple[int, ...] | None=None, *, options: TensorMapDescriptorOptions | None=None, element_strides: tuple[int, ...] | None=None, data_type: object | None=None, interleave: object | None=None, swizzle: object | None=None, l2_promotion: object | None=None, oob_fill: object | None=None) -> object:
        ...
        options via ``options=``.
        """
    def copy_from(self, other: StridedMemoryView, stream: Stream, allocator: object | None=None, blocking: bool | None=None) -> None:
        """
        ...
        """
    def copy_to(self, other: StridedMemoryView, stream: Stream | None=None, allocator: object | None=None, blocking: bool | None=None) -> None:
        """
