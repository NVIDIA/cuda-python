# This file was generated by stubgen-pyx v0.2.19 from cuda_core/cuda/core/_module.pyx
...
class KernelOccupancy:
    ...
    def max_active_blocks_per_multiprocessor(self, block_size: int, dynamic_shared_memory_size: int) -> int:
        ...
        """
    def max_potential_block_size(self, dynamic_shared_memory_needed: int | driver.CUoccupancyB2DSize, block_size_limit: int) -> Any:
...
class Kernel:
    ...
    @property
    def arguments_info(self) -> list[Any]:
