...
cdef extern from "_cpp/resource_handles.hpp" namespace "cuda_core":
    ...
    ArrayHandle create_array_handle "cuda_core::create_array_handle" (
        const cydriver.CUDA_ARRAY3D_DESCRIPTOR& desc) except+ nogil
    ArrayHandle create_array_handle_ref "cuda_core::create_array_handle_ref" (
        cydriver.CUarray arr) except+ nogil
    ArrayHandle create_array_handle_owning "cuda_core::create_array_handle_owning" (
        cydriver.CUarray arr) except+ nogil
    ArrayHandle create_array_level_handle "cuda_core::create_array_level_handle" (
