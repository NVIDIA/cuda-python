# This file was generated by stubgen-pyx v0.2.22 from cuda_core/cuda/core/system/_device.pyx

from typing import Any, Coroutine, Iterable, TypedDict
...
class _GpuDynamicPstatesUtilization(TypedDict):
    bIsPresent: int
    percentage: int
    incThreshold: int
    decThreshold: int

class _ThermalSensor(TypedDict):
    controller: int
    defaultMinTemp: int
    defaultMaxTemp: int
    currentTemp: int
...
class DeviceEvents:
    ...
    def wait(self, timeout_ms: int=0) -> EventData:
        ...
        """
    def wait_async(self, timeout_ms: int=0) -> Coroutine[Any, Any, EventData]:
        """
