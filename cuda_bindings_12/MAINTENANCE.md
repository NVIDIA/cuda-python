...
The base imported tree comes from
`NVIDIA/cuda-python@238955935bd903ac72817c0dfdfe4f6a54ee6bb1:cuda_bindings`.
The 28 generated paths changed for the CUDA Bindings 12.9.8 release were later
copied as complete, sealed files from
`NVIDIA/cuda-python@826f10e0e80dc0c2294d5a5aae21f7c6fe32bef2:cuda_bindings`;
the 12.9.8 release note was copied from the same snapshot. The public release
commit does not record a single cybind revision that reproduces this finalized
generated snapshot.

Cybind commit `95d8bb525de46a9ff7ae40d759a98cbe50cf8391`
reproduces 52 generated paths in the base snapshot, including all 40 generated
...
Megaheader-backed files can match across roots when both snapshots expose the
same latest public APIs, as they do for the 12.9.8 and 13.4.1 snapshots. This
is not a cross-major invariant: a prerelease target may legitimately diverge
while the maintenance line remains capped at the latest public release.
