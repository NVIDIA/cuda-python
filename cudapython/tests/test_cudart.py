...
import pytest
import cudapython.cudart as cudart
import cudapython.cuda as cuda
import numpy as np
import math
...
def test_cudart_graphs():
    ...
    # path = b'/home/vzhurba/tip/cuda-python/cudapython/tests/dump'
    # err, = cudart.cudaGraphDebugDotPrint(graph, path, cudart.cudaGraphDebugDotFlags.cudaGraphDebugDotFlagsVerbose.value)
    # assertSuccess(err)
    ...
    assertSuccess(err)
    # print(stream_legacy)
    # print(stream_per_thread)
    # print(stream_with_flags)
    # print('Flag value: ' + str(cudart.cudaStreamNonBlocking))
