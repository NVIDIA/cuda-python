...
This is the only end-to-end numerical solver in `/samples` that uses
grid-level cooperative synchronization. The simpler
[`samples/reductionMultiBlockCG/`](../../reductionMultiBlockCG/) uses the
...
- [`samples/reductionMultiBlockCG/`](../../reductionMultiBlockCG/) - simpler cooperative-launch demo
