...
- [`samples/cuda_core/glInteropFluid/`](../glInteropFluid/) — larger demo using TextureObject + SurfaceObject
- [`samples/cuda_core/glInteropMipmapLod/`](../glInteropMipmapLod/) — mipmap / LOD demo
