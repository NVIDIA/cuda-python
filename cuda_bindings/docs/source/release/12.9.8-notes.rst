...
* Fixed a potential data race in the lazy initialization of the driver,
  runtime, NVRTC, NVML, nvJitLink, nvFatbin, and cuFile bindings, where
...
* A missing driver or NVRTC function now raises ``FunctionNotFoundError``
  (a subclass of ``RuntimeError``) instead of a bare ``RuntimeError``.
  (`PR #2206 <https://github.com/NVIDIA/cuda-python/pull/2206>`_)
