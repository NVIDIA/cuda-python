...
# CYTHON-BINDINGS-GENERATED-DO-NOT-MODIFY-THIS-FILE: format=1; content-sha256=924be66344cb7c8837c46976a9f394569b0e5d00df6b5026ad42ef6d1258984f
...
ctypedef enum nvmlDeviceGpuRecoveryAction_t "nvmlDeviceGpuRecoveryAction_t":
    ...
    NVML_GPU_RECOVERY_ACTION_BUS_RESET "NVML_GPU_RECOVERY_ACTION_BUS_RESET" = 6
    NVML_GPU_RECOVERY_ACTION_SYSTEM_REBOOT "NVML_GPU_RECOVERY_ACTION_SYSTEM_REBOOT" = 7
...
ctypedef enum nvmlGpuOperationalEventContextType_t "nvmlGpuOperationalEventContextType_t":
    NVML_GPU_OPERATIONAL_EVENT_CONTEXT_TYPE_UNKNOWN "NVML_GPU_OPERATIONAL_EVENT_CONTEXT_TYPE_UNKNOWN" = 0
    NVML_GPU_OPERATIONAL_EVENT_CONTEXT_TYPE_LEGACY_XID "NVML_GPU_OPERATIONAL_EVENT_CONTEXT_TYPE_LEGACY_XID" = 1
...
ctypedef struct nvmlSetMemoryLimits_v1_t 'nvmlSetMemoryLimits_v1_t':
    char* nameSpace
    unsigned long long softLimit
    unsigned long long hardLimit

ctypedef struct nvmlGetMemoryLimits_v1_t 'nvmlGetMemoryLimits_v1_t':
    char* nameSpace
    unsigned long long softLimit
    unsigned long long hardLimit
