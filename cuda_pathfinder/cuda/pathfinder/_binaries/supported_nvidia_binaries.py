...
SITE_PACKAGES_BINDIRS = {
    ...
    "nvcc": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    "nvdisasm": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    "cuobjdump": (_CUDA_NVCC_BIN,),
    "nvprune": (_CUDA_NVCC_BIN,),
    "fatbinary": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    "bin2c": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    "nvlink": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    # Runtime/debugging tools
    "cuda-gdb": (_CUDA_NVCC_BIN,),
    "cuda-gdbserver": (_CUDA_NVCC_BIN,),
    "compute-sanitizer": (_CUDA_NVCC_BIN, _CUDA13_BIN),
    # Profiling tools
