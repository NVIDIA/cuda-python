...
* Add :func:`windows_supported_arches` to query the explicitly authored Windows
  target architectures for any known NVIDIA dynamic-library descriptor,
  independent of the current host and Python interpreter architectures.
